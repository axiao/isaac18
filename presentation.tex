...
%TODO
% first problem: find the minimum-cost matching over all translations (example figure)
% explain static problem with a figure: ``if t is fixed, we have a well-studied problem for which there exist polytime algorithms''
...
%TODO behavior under perturbations
...
%TODO 1-d approximation idea, transition 1-D to 2-D
...
%TODO figures describing voronoi diagram and equipping matching to cell
%\begin{figure}
%\begin{center}
%\includegraphics<1>[width=0.6\textwidth,page=1]{point-to-point}%
%\includegraphics<2>[width=0.6\textwidth,page=2]{point-to-point}%
